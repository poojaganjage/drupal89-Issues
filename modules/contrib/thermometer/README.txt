...
Enable the module. Go to the blocks page and configure the “Progress Thermometer" block. Place it where you want to see it! Configuration is available when you first place the block, and anytime thereafter by accessing it from the blocks page.
